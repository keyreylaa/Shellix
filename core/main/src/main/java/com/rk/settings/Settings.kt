...
import com.rk.shellix.ui.screens.settings.InputMode
...
object Settings {
   ...
   var default_night_mode
    ...
    fun getShortcutBinding(action: com.rk.shellix.ui.screens.terminal.ShortcutAction): com.rk.shellix.ui.screens.terminal.ShortcutBinding {
        val raw = Preference.getString(key = action.prefKey, default = action.default.serialize())
        return com.rk.shellix.ui.screens.terminal.ShortcutBinding.deserialize(raw)
    }

    fun setShortcutBinding(action: com.rk.shellix.ui.screens.terminal.ShortcutAction, binding: com.rk.shellix.ui.screens.terminal.ShortcutBinding) {
